...
public class TestOblig3 {
    ...
    private static void testOrdnetLenkelisteIterator() {
        ...
        try {
            ...
            testIteratorHasNext(ordnetlisteIterator, "hasNext() i OrdnetListe med elementer", true);
            testIteratorNext(ordnetlisteIterator, "next() i OrdnetListe med elementer", "elementAA");
